...
\newcommand{\FMBCC}{\mf{FMBCC}(\mf{At})}
...
\subsection{Axiomatic Calculus and Categorical Semantics}\label{sec:cat:sem}
...
$\FMBCC$ is the category generated by the (\ref{eq:axiomatic:calculus}) with the equational theory on derivations.
