...
\section{Categorical Models}\label{sec:cat:sem}
In this section we present the categorical models of \NL, magmatic biclosed categories and (strict) functors between them.
